#include<iostream>
#include<fstream> // Incluye la biblioteca fstream para la manipulación de archivos
#include<string.h> // Incluye la biblioteca string.h para el manejo de cadenas
#include<ctime> // Incluye la biblioteca ctime para trabajar con la fecha y hora
#include<conio.h> // Incluye la biblioteca conio.h para funcionalidades de la consola
#include"clases.cpp" // Incluye el archivo de código fuente clases.cpp
using namespace std; 
		...
		switch (opcion) {
            case 1: {
                ...
                for (int i = 0; i < n; i++){
					...
					time_t t;
					t = time(NULL);
					struct tm* fecha; // Corrección: se debe declarar como puntero a struct tm
					fecha = localtime(&t);
					dia = fecha->tm_mday;
					mes = fecha->tm_mon + 1;
                ...
                reporte_mot.close();
                reportem.close(); // Cierra el archivo de salida "reportem"
				system("cls"); // Limpia la pantalla de la consola
				cout << "moto(s) añadidos correctamente\n\n";
				cout << "\n\npresione cualquier tecla para volver al menu.";
				getch(); // Espera a que el usuario presione una tecla
				system("cls"); // Limpia la pantalla de la consola
				break; // Sale del caso 1 del switch
            }
            case 2: {
                system("cls");// Limpia la pantalla de la consola
			    ...
			    getch(); // Espera a que el usuario presione una tecla
			    system("cls"); // Limpia la pantalla de la consola
				break; // Sale del caso 2 del switch
            }
            case 3:{
            	system("cls");
            	ifstream ver_stock;
			    ...
			    getch(); // Espera a que el usuario presione una tecla
			    system("cls"); // Limpia la pantalla de la consola
			    break; // Sale del caso 3 del switch
			}
            case 4: {
            ...
            case 6: {
	            ...
	            for(int l=0;l<n;l++){
					...
					while(reportec>>dia>>horas>>minutos>>clientec>>dn>>producto>>cantidad){//lee el arechivo y guarda las variables de este
						int r;
						if(dn==dn){
							r=11;
							cout<<"cacacacca";
            ...
            break;
            case 7:{
					exit(1);//funcion exit, saldra del programa
			}
        }
